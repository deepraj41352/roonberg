                            ...
                            <Card className={`${theme}CardBody`}>
                                <Form onSubmit={submitHandler} className="p-4 w-100 formWidth ">
                                    <Form.Group className="mb-3 " controlId="formBasicEmail">
                                        <Form.Label className="mb-1 input-box">Category Name</Form.Label>
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicEmail">
                                        <Form.Label className="mb-1 input-box">Description</Form.Label>
                                        <Form.Control className="input-box-inner"
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                        ...
                                        <Form.Control className="input-box-inner" type="file" onChange={handleFileChange} />
                                    </Form.Group>
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
