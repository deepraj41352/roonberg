        ...
        <>
            ...
            <Modal open={isModelOpen} onClose={handleCloseRow}>
                <Box className='modelBg' sx={{
                    ...
                    <Form>
                        {isNewContractor ? (
                            <h4 className='d-flex justify-content-center'>Add new Contractor Details</h4>
                        ) : (
                            <h4 className='d-flex justify-content-center'>Edit Contractor Details</h4>
                        )}
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.agentName : '')}
                            label="Agent Name"
                            fullWidth
                        />
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.contractorName : '')}
                            label="Contractor Name"
                            fullWidth
                        />
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.projectName : '')}
                            label="Project Name"
                            fullWidth
                        />
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.progress : '')}
                            label="Progress"
                            fullWidth
                        />
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.startDate : '')}
                            label="Start Date"
                            fullWidth
                        />
                        <TextField
                            className='mb-2'
                            value={isNewContractor ? '' : (selectedRowData ? selectedRowData.endDate : '')}
                            label="End Date"
                            fullWidth
                        />
                        <Button variant="contained" color="primary" onClick={handleSubmitNewContractor} onChange={(e) => e.target.value}>
