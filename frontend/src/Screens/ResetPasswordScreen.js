                    ...
                    <Col>
                        <Card className='p-4 formColor'>
                            <Form onSubmit={handleSubmit} className='formWidth d-flex flex-column'>
                                ...
                                <Form.Control className='px-2  py-1 mb-3' value={email} type='email' onChange={(e) => setEmail(e.target.value)} required />
                                <Validations type="email" value={email} />

                                <Form.Label className='textLeft text-left'>Password</Form.Label>
                                <Form.Control className='px-2  py-1 mb-3' type='password' value={password} onChange={(e) => setPassword(e.target.value)} required />
                                <Validations type="password" value={password} />

                                <Form.Label className='textLeft text-left'>Confirm Password</Form.Label>
                                <Form.Control className='px-2  py-1 mb-3' type='password' value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} required />
